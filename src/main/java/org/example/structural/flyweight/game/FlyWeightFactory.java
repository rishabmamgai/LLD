...
import org.example.structural.flyweight.flyweights.PrimaryWeapon;
import org.example.structural.flyweight.flyweights.SecondaryWeapon;
import org.example.structural.flyweight.flyweights.Weapon;
import org.example.structural.flyweight.flyweights.Weapon.WeaponType;
...
public class FlyWeightFactory {
    ...
    public static Weapon getCharacter(String name, WeaponType type) {
